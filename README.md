...
- Chat preflight cost checks use your refreshed model snapshot when present, and fall back to the bundled starter catalog so first-run estimates do not become “unknown” just because the rates file has not been written yet.
